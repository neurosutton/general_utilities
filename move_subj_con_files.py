...
if task == 'priming':
    ...
    results_to_grab = {'fp_results':['con_0005'],'fp_results_post':['con_0005'], 'priming_results':['con_0001']}
    ...
    analysis_dir = '/data/analysis/brianne/exobk/contrasts_ART'

    # Following result directory name: contrast file, compose a result dictionary
    results_to_grab = {'fp_resultsArt':['con_0005','con_0006'], 'fp_resultsArt_fed':['con_0005','con_0006']}
